...
export const Skills = () => {
    ...
    return (
        <section className="skill" id="skills">
                        ...
                        <div className="skill-bx">
                                ...
                                >
                                    {skillsData.map((skill, index) => (
                                        <div
                                            ...
                                            onMouseEnter={(e) => handleMouseEnter(e, skill.boxShadowColor)}
                                            onMouseOut={(e) => handleMouseOut(e, skill.boxShadowColor)}
                                        >
                                            <img
                                                src={skill.icon}
                                                alt={skill.name}
                            ...
                            <div className="skill-bx">
                                <h2 className="mt-5">
                                    Additional Skillset
                                    <p>
                                        In addition to software development, I have a strong foundation
                                        in the use of a variety of visual media tools.
                                    </p>
                                    <div
                                        className="skill-grid-container"
                                        style={{
            ...
            <img className="background-image-left" alt="" src={colorSharp} loading="lazy" /> {/* Add the loading attribute here */}
        </section>
    );
};
